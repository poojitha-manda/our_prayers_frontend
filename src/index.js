...
import PopularSelect from "./components/popular/PopularSelect";
//Coupons
          ...
          <BrowserRouter basename={`/`}>
            <Switch>
              ...
              <App>
                ...
                {/* Dashboard page */}
                <Route
                  path={`${process.env.PUBLIC_URL}/admindashboard/dashboard`}
                  component={Dashboard}
                />
                {/* Vendor */}
                <Route
                  path={`${process.env.PUBLIC_URL}/vendor/addvendor/:religion/:religionPlace/:location`}
                  component={AddVendor}
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/vendor/viewvendors`}
                  component={ViewVendors}
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/vendor/editvendor/:id`}
                ...
                <Route
                  path={`${process.env.PUBLIC_URL}/product/viewproducts`}
                  component={ViewProducts}
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/product/editproduct/:id`}
                ...
                <Route
                  path={`${process.env.PUBLIC_URL}/user/viewusers`}
                  component={ViewUsers}
                />

                {/* Orders */}
                <Route
                  path={`${process.env.PUBLIC_URL}/order/editorder/:id`}
                  component={EditOrder}
                />

                <Route
                  path={`${process.env.PUBLIC_URL}/order/vieworders`}
                  component={ViewOrders}
                />
                {/* Popular */}
                <Route
                  path={`${process.env.PUBLIC_URL}/popular/editpopular/:id`}
                  component={EditPopular}
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/popular/addpopular`}
                  component={AddPopular}
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/popular/viewpopular/:religion`}
                  component={ViewPopular}
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/popular/popularselect`}
                  component={PopularSelect}
                />

                {/* Coupons */}
                <Route
                  path={`${process.env.PUBLIC_URL}/coupons/addcoupon`}
                  component={AddCoupon}
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/coupons/editcoupon/:id`}
                  component={EditCoupon}
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/coupons/viewcoupons`}
                ...
                {/* base */}
                <Route
                  path={`${process.env.PUBLIC_URL}/base/statecolor`}
                  component={Statecolor}
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/base/typography`}
                  component={Typography}
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/base/avatar`}
                  component={Avatar}
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/base/grid`}
                  component={Grid}
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/base/helperclass`}
                  component={HelperClass}
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/base/tagsandpills`}
                ...
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/base/popoverComponent`}
                ...
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/base/spinner`}
                  component={Spinner}
                />
                <Route
                ...
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/base/tabs/tab-bootstrap`}
                  component={TabBootstrap}
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/base/tabs/tab-line`}
                  component={TabLine}
                />
                <Route
                ...
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/base/navs`}
                  component={Navs}
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/base/shadow`}
                  component={Shadow}
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/base/list`}
                  component={List}
                />
                ...
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/advance/bootstrap-notify`}
                  component={Toastr}
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/advance/ratingComponent`}
                ...
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/advance/slick-slider`}
                  component={SlickSlider}
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/advance/carouselComponent`}
                  component={CarouselComponent}
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/advance/ribbon`}
                  component={Ribbon}
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/advance/pagination`}
                  component={Pagination}
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/advance/steps`}
                  component={Steps}
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/advance/uibreadcrumb`}
                ...
                {/* Forms */}
                <Route
                  path={`${process.env.PUBLIC_URL}/forms-controls/form-validation`}
                  component={FormValidation}
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/forms-controls/baseInput`}
                  component={BaseInput}
                />
                <Route
                ...
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/forms-controls/inputGroup`}
                  component={InputGroupComp}
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/forms-controls/megaOptions`}
                ...
                <Route
                  path={`${process.env.PUBLIC_URL}/form-widget/datepickerComponent`}
                ...
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/knob/knob-charts`}
                  component={Knobcharts}
                />
                ...
                {/* Bookmark App */}
                <Route
                  path={`${process.env.PUBLIC_URL}/bookmark-app/bookmark`}
                  component={BookmarkApp}
                />

                {/* Task App */}
                <Route
                  path={`${process.env.PUBLIC_URL}/taks-app/task`}
                  component={TaskApp}
                />
                ...
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/project/project-details`}
